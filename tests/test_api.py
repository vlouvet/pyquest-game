...
def auth_headers(client):
    ...
    # Register user
    client.post(
        "/api/v1/auth/register", json={"username": "testuser", "email": "test@example.com", "password": "TestPass123!"}
    )
...
class TestAuthentication:
    ...
    def test_login_success(self, client):
        ...
        client.post(
            "/api/v1/auth/register",
            json={"username": "logintest", "email": "login@example.com", "password": "LoginPass123!"},
        )

        # Login
        response = client.post("/api/v1/auth/login", json={"username": "logintest", "password": "LoginPass123!"})
    ...
    def test_login_invalid_credentials(self, client):
        ...
        response = client.post("/api/v1/auth/login", json={"username": "nonexistent", "password": "wrongpass"})
...
class TestUsers:
    ...
    def test_create_character(self, client, auth_headers):
        ...
        response = client.post(
            ...
            json={"char_name": "Aragorn", "char_class": "ranger", "char_race": "human"},
        )
    ...
    def test_create_character_missing_fields(self, client, auth_headers):
        ...
        response = client.post("/api/v1/player/characters", headers=auth_headers, json={"char_name": "Incomplete"})
    ...
    def test_get_character_by_id(self, client, auth_headers, test_character):
        ...
        response = client.get(f"/api/v1/player/characters/{char_id}", headers=auth_headers)
    ...
    def test_get_character_not_found(self, client, auth_headers):
        ...
        response = client.get("/api/v1/player/characters/99999", headers=auth_headers)
    ...
    def test_update_character(self, client, auth_headers, test_character):
        ...
        response = client.patch(
            f"/api/v1/player/characters/{char_id}", headers=auth_headers, json={"hit_points": 75, "experience": 500}
        )
    ...
    def test_get_character_stats(self, client, auth_headers, test_character):
        ...
        char_id = test_character["id"]
        response = client.get(f"/api/v1/player/characters/{char_id}/stats", headers=auth_headers)
...
class TestTiles:
    ...
    def test_get_current_tile(self, app, client, auth_headers, test_character):
        ...
        response = client.get(f"/api/v1/player/{player_id}/tiles/current", headers=auth_headers)
    ...
    def test_get_tile_by_id(self, app, client, auth_headers, test_character):
        ...
        player_id = test_character["id"]
        response = client.get(f"/api/v1/player/{player_id}/tiles/{tile_id}", headers=auth_headers)
...
class TestCombat:
    ...
    def test_get_combat_actions(self, app, client, auth_headers, test_character):
        ...
        player_id = test_character["id"]
        response = client.get(f"/api/v1/player/{player_id}/tiles/{tile_id}/combat-actions", headers=auth_headers)
    ...
    def test_execute_combat_action(self, app, client, auth_headers, test_character):
        ...
        response = client.post(
            ...
            headers=auth_headers,
            json={"tile_id": tile_id, "combat_action_code": "attack_light"},
        )
    ...
    def test_get_encounters(self, client, auth_headers, test_character):
        ...
        player_id = test_character["id"]
        response = client.get(f"/api/v1/player/{player_id}/encounters", headers=auth_headers)
