...
def get_characters():
    ...
    return jsonify({
        'characters': [_format_user_as_character(user)]
    }), 200
...
def get_character_stats(character_id):
    ...
    return jsonify({
        ...
        'statistics': {
            ...
            'success_rate': round(successful_encounters / total_encounters * 100, 2) if total_encounters > 0 else 0,
            'total_damage_dealt': total_damage_dealt,
            'total_damage_received': total_damage_received,
            'average_damage_dealt': round(total_damage_dealt / total_encounters, 2) if total_encounters > 0 else 0
        }
    }), 200
